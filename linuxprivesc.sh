...
psql -U postgres template0 -c "select versi#!/bin/sh
...
psql -U postgres template1 -c "select version()" 2> /dev/null | grep version
...
psql -U pgsql template0 -c "select version()" 2> /dev/null | grep version
...
psql -U pgsql template1 -c "select version()" 2> /dev/null | grep version
...
ls /etc/sssd/sssd.conf 2> /dev/null
